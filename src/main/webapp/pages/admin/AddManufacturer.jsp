...
<head>
  <meta charset="UTF-8">
  <title>Add Manufacturer - Departmental Store</title>
  <link rel="stylesheet" href="${pageContext.request.contextPath}/css/AddManufacturerStyles.css">
</head>
...
<body>
  ...
  <div class="form-container">
    ...
    <form action="${pageContext.request.contextPath}/AddManufacturerController" method="post">
      <label for="name">Manufacturer Name</label>
      <input type="text" id="name" name="name" placeholder="Enter manufacturer name" required>
